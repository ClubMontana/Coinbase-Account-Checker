...
\e[1;33m
   ___      _       _                        ___ _               _             
  / __\___ (_)_ __ | |__   __ _ ___  ___    / __\ |__   ___  ___| | _____ _ __ 
 / /  / _ \| | '_ \| '_ \ / _` / __|/ _ \  / /  | '_ \ / _ \/ __| |/ / _ \ '__|
/ /__| (_) | | | | | |_) | (_| \__ \  __/ / /___| | | |  __/ (__|   <  __/ |   
\____/\___/|_|_| |_|_.__/ \__,_|___/\___| \____/|_| |_|\___|\___|_|\_\___|_|   
                                                                             
\e[1;37m
  Coinbase Account Checker \e[1;34m-\e[1;37m By \e[1;34m:\e[1;37m Tony \e[1;34m-\e[1;37m R.M. Team
'''

# ask file
echo -e "${white}[ ${red}INFO ${white}] ONLY INPUT LIST USING DELIMITER ${blue}'${green}|${blue}' ${white}[ ${green}Ex ${blue}: ${green}EMAIL|PASS ${white}]"
...
if [[ ! -e $ask_files ]]; then
	...
	echo -e "${white}[ ${green}+ ${white}] START CHECKING PROCESS\n"
fi
...
echo -e "${white}[ ${green}? ${white}] TOTAL VALID ACCOUNT ${blue}: ${green}$(< VALID_ACCOUNTS.txt wc -l)${white}"
